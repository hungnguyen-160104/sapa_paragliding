/**
 * Standalone Telegram Bot Handler
 * 
 * This script starts the Telegram bot with polling to listen for messages
 * Usage: node scripts/start-telegram-bot.js
 */
...
console.log('🚀 Starting Telegram Bot Handler...\n')
...
console.log('📱 Send /start to the bot to get your Chat ID\n')
