...
const nextPost = () => {
  const maxIndex = Math.max(Math.ceil(latestPosts.value.length / 3) - 1, 0)
...
const getGalleryTitle = (item: any) => {
  ...
  return item[`title${suffix}`] || item.titleEn || item.title || ''
}

const getGalleryDescription = (item: any) => {
  const suffix = localeSuffixMap[currentLocale.value] || 'En'
  return item[`description${suffix}`] || item.descriptionEn || item.description || ''
}
  ...
  <main class="min-h-screen">
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden py-16 md:py-14">
      <div class="absolute inset-0">
        ...
        <video
          ref="heroVideo"
          poster="/images/pilot_background.webp"
          autoplay
          muted
          loop
          playsinline
        ...
        <div class="relative">
          ...
          <div v-if="latestPosts.length > 3" class="flex justify-center items-center gap-4 mt-4">
            ...
            <div class="flex gap-2">
              <button
                v-for="(_, index) in Math.ceil(latestPosts.length / 3)"
                :key="index"
                :class="[
    ...
    <section class="py-10 lg:py-16 bg-gradient-to-br from-slate-100 via-white to-slate-50">
      <div class="container mx-auto px-6 lg:px-12">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-3">
          <div class="contact-card bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal group" data-delay="0">
            <div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg class="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0C5.373 0 0 4.925 0 11c0 2.882 1.157 5.527 3.058 7.55C2.725 20.36 1.92 22.09 1.92 22.09s2.63-.78 4.67-2.01C8.35 21.01 10.13 22 12 22c6.627 0 12-4.925 12-11S18.627 0 12 0z" />
              </svg>
            </div>
          ...
          <div class="contact-card bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal group" data-delay="50">
            <div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
          ...
          <div class="contact-card bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal group" data-delay="100">
            ...
            <a
              href="https://www.tiktok.com/@sapa_paragliding"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div class="contact-card bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal group" data-delay="150">
            <div class="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://www.youtube.com/@sapa.paragliding"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div class="contact-card bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal group col-span-2 sm:col-span-1" data-delay="200">
            <div class="w-12 h-12 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
              <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://www.instagram.com/SAPA_PARAGLIDING"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <div class="contact-card bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal" data-delay="250">
            ...
            <h3 class="text-base font-bold text-slate-900 text-center mb-3">Hotline 24/7</h3>
          ...
          <a
            href="mailto:sapa.paragliding@gmail.com"
          ...
          <div class="contact-card bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-all duration-300 scroll-reveal" data-delay="350">
