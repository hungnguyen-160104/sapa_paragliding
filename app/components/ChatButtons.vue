<template>
  ...
  <div class="fixed bottom-6 right-6 z-40 flex flex-col space-y-3 origin-bottom-right max-md:scale-[0.8]">
    ...
    <a :href="zaloUrl" target="_blank" rel="noopener noreferrer"
      class="group bg-blue-500 hover:bg-blue-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-110"
      aria-label="Chat on Zalo">
      <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
    ...
    <button v-if="showScrollTop" @click="scrollToTop"
      class="bg-gray-700 hover:bg-gray-800 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-110"
...
const zaloUrl = computed(() => config.public.zaloUrl)
const whatsappUrl = computed(() => config.public.whatsappUrl)
