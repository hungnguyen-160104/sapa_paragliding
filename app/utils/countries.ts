// Full list of world countries with international dialing codes and flag emojis.
// Used by the booking phone-number country selector.
// Vietnam is pinned first (primary market); the rest are alphabetical by English name.

export interface Country {
  /** ISO 3166-1 alpha-2 code (unique — use as list key) */
  iso: string
  /** English country name */
  name: string
  /** International dialing code, e.g. "+84" */
  dial: string
  /** Flag emoji */
  flag: string
}
